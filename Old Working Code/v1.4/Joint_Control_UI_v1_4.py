...
from Robot_Interpreter_v1_4 import RobotInterpreter, MAX_SERVO_ANGLE
...
SERVO_JOINTS = [4, 5, 6]  # Joints using servos
...
class JointControlUI:
    def __init__(self, root):
        ...
        self.create_joint_row(6, "Joint 6 (Servo Z)", 6)
    ...
    def query_joint(self, joint: int):
        ...
        try:
            if joint == 1:
                ...
                self.message_label.config(text=f"Joint 6 (Z): Angle {angle:.1f}°, Speed {speed:.3f} RPS", foreground="black")
        except Exception as e:
