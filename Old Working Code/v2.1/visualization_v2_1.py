...
class VizScene:
    ...
    def add_arm(self, arm, draw_frames=False, label_axes=False, joint_colors=None, size_scale=1.0):
        """
        ...
        """
        a = ArmMeshObject(arm, draw_frames=draw_frames, label_axes=label_axes, joint_colors=joint_colors, size_scale=size_scale)
        self.arms.append(a)
        a.update()
...
class ArmMeshObject:
    def __init__(self, arm, link_colors=None, joint_colors=None, q0=None,
                 draw_frames=False, label_axes=False, size_scale=1.0):
        self.arm = arm
        self.n = arm.n
        self.dh = arm.dh
        ...
        link_width = np.max([arm_scale, 0.10])*0.20*size_scale
        joint_width = np.max([arm_scale, 0.10])*0.30*size_scale
        joint_height = np.max([arm_scale, 0.10])*0.70*size_scale
