...
from Robot_Interpreter_v2_2 import RobotInterpreter, MAX_SERVO_ANGLE
import threading
import time
...
import numpy as np
from kinematics_v2_2 import SerialArm
import transforms_v2_2 as tr
from example_sim_scoop_v2_2 import dh, jt_types, CARRY_TILT, CARRY_TILT_DEG, JOINT_LIMITS_DEG, JOINT_LIMITS_RAD, tip
...
class JointControlUI:
    ...
    def _plan_waypoints(self, arm: SerialArm) -> list[np.ndarray]:
        ...
        z_above = 0.100
        z_table = -0.050          # where the scoop scrapes
        z_carry = 0.200          # level-carry height above table
    ...
    def _wait_all_idle(self, max_wait: float = 50.0, query_period: float = 0.05) -> bool:
