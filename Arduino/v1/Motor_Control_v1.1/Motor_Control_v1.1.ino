...
// v1.1: Added query support; no core FSM changes.

// Pin Assignments
#define STEPB_DIR_PIN 10   // Bottom DIR
#define STEPB_STEP_PIN 9   // Bottom STEP
...
// Shared Constants
const float MAX_COLD_START_RPS = 0.00f;
const float STEP_RAMP_ACCEL = 2.0f;
