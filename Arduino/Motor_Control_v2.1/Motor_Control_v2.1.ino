...
void Handle_Servo_Query(char servo_id) {
  ...
  float offset;
  switch (servo_id) {
    case SERVO_X: motor = &motor_x; offset = SERVO_OFFSET_X; break;
    case SERVO_Y: motor = &motor_y; offset = SERVO_OFFSET_Y; break;
    case SERVO_Z: motor = &motor_z; offset = SERVO_OFFSET_Z; break;
    default: Serial.println("Invalid ID."); return;
  }
